...
def run(n_macroparticles, n_macroparticles_ions, gap_length=0, n_turns=2000, n_segments=50, h_rf=416, gap_every_104=False, interaction_model='weak', interaction_model_ions='weak', smooth=False):
    if gap_every_104:
    ...
    eta_x_0 = np.load(
        '/home/dockeruser/fbii_pyht_tracking/lattice_functions/eta_x.npy')
...
#        electron_bunch.y += np.random.normal(scale=0.02*electron_bunch.sigma_y(), size=1)
    ...
    if smooth == True:
        ...
        s_0 = np.load(
            '/home/dockeruser/fbii_pyht_tracking/lattice_functions/s.npy')
        beta_x_0 = np.load(
            '/home/dockeruser/fbii_pyht_tracking/lattice_functions/beta_x.npy')
        beta_y_0 = np.load(
            '/home/dockeruser/fbii_pyht_tracking/lattice_functions/beta_y.npy')
        alpha_x_0 = np.load(
            '/home/dockeruser/fbii_pyht_tracking/lattice_functions/alpha_x.npy')
        alpha_y_0 = np.load(
            '/home/dockeruser/fbii_pyht_tracking/lattice_functions/alpha_y.npy')
        eta_x_0 = np.load(
            '/home/dockeruser/fbii_pyht_tracking/lattice_functions/eta_x.npy')
        eta_y_0 = np.load(
            '/home/dockeruser/fbii_pyht_tracking/lattice_functions/eta_y.npy')
        beta_x = []
        beta_y = []
        alpha_x = []
        alpha_y = []
...
if __name__ == "__main__":
    ...
    run(n_macroparticles[slurm_array_task_id], n_macroparticles_ions=int(
        1e4), gap_length=50, n_segments=n_segments, smooth=is_smooth)
    sys.exit()
