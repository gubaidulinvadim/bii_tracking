...
def write_tmp_submission_script_ccrt(job_name,
    ...
    with open(job_name, "w") as f:
        ...
        f.write(
            "pcocc run --mount {0:} -I {1:} --entry-point -- python {2:} --is_smooth {3:} --gap_length {4:} --n_gaps {5:} --interaction_model_ions {6:} --n_segments {7:} --charge_variation {8:} --pressure_variation {9:} --average_pressure {10:} --beam_current {11:} --ion_mass {12:} --sigma_i {13:}\n".format(MOUNT_FOLDER,
                                                                                                                                                                                                                                                                                                                     IMAGE_NAME,
                                                                                                                                                                                                                                                                                                                     SCRIPT_NAME,
                                                                                                                                                                                                                                                                                                                     is_smooth,
                                                                                                                                                                                                                                                                                                                     gap_length,
...
def write_tmp_submission_script_ccrt_gpu(job_name,
    ...
    with open(job_name, "w") as f:
        ...
        f.write('module purge\n')
        f.write(
            "pcocc run --mount {0:} -M nvidia -I {1:} --entry-point -- python {2:} --is_smooth {3:} --gap_length {4:} --n_gaps {5:} --interaction_model_ions {6:} --n_segments {7:} --charge_variation {8:} --pressure_variation {9:} --average_pressure {10:} --beam_current {11:} --ion_mass {12:} --sigma_i {13:}\n".format(MOUNT_FOLDER,
                                                                                                                                                                                                                                                                                                                               IMAGE_NAME,
                                                                                                                                                                                                                                                                                                                               SCRIPT_NAME,
                                                                                                                                                                                                                                                                                                                               is_smooth,
                                                                                                                                                                                                                                                                                                                               gap_length,
...
def write_submission_script_slurm(job_name,
    ...
    with open(job_name, "w") as f:
        ...
        f.write(
            "singularity exec --no-home --nv -B {0:} {1:} python {2:} --is_smooth {3:} --gap_length {4:} --n_gaps {5:} --interaction_model_ions {6:} --n_segments {7:} --charge_variation {8:} --pressure_variation {9:} --average_pressure {10:} --beam_current {11:} --ion_mass {12:} --sigma_i {13:}\n".format(MOUNT_FOLDER,
                                                                                                                                                                                                                                                                                                                  IMAGE_NAME,
                                                                                                                                                                                                                                                                                                                  SCRIPT_NAME,
                                                                                                                                                                                                                                                                                                                  is_smooth,
                                                                                                                                                                                                                                                                                                                  gap_length,
